...
const INITIAL_STATE = {userId: null, status: null, firstName: null, lastName: null, error: null, loading: false};
...
export default function (state = INITIAL_STATE, action) {
  ...
  switch (action.type) {
    case SIGNIN:
      return {...state, userId: null, filename: null, lastName: null, status: 'signin', error: null, loading: true};
    case SIGNIN_SUCCESS:
